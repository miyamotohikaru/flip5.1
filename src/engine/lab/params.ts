...
export const LAB_PARAMS: LabParam[] = [
  // ------------------------------ 地形（焼き直しが要る） ------------------------------
  {
    id: "terrainAmp", key: "terrain.amp", group: "terrain", label: "山脈の高さ", min: 0.3, max: 1.8, step: 0.01, unit: "×",
  ...
  {
    id: "terrainErode", key: "terrain.erode", group: "terrain", label: "侵食の強さ", min: 0, max: 3, step: 0.01, unit: "×",
  ...
  // ------------------------------ 水 ------------------------------
  {
    id: "waterWind", key: "water.wind", group: "water", label: "風速", min: 0.2, max: 3, step: 0.01, unit: "×",
  ...
  {
    id: "waterPeriod", key: "water.period", group: "water", label: "波の周期", min: 0.4, max: 2.5, step: 0.01, unit: "×",
  ...
  // ------------------------------ 木と草 ------------------------------
  {
    id: "vegGrass", key: "veg.grass", group: "veg", label: "草の密度", min: 0, max: 2, step: 0.01, unit: "×",
  ...
  {
    id: "vegTree", key: "veg.tree", group: "veg", label: "木の密度", min: 0, max: 2, step: 0.02, unit: "×",
  ...
  // ------------------------------ 音 ------------------------------
  {
    id: "audioGust", key: "audio.gust", group: "audio", label: "突風の変調の深さ", min: 0, max: 3, step: 0.01, unit: "×",
    formula: "g(t) = base + 〔D〕 · depth · gust(t)",
    src: "audio/wind.ts tick()（各帯の変調量）",
    live: (v) => `変調量 ×${f(v)}（0 で一定の「ゴー」、3 で息づく）`,
  },
  {
    id: "audioBand", key: "audio.band", group: "audio", label: "ざわめきの帯", min: 0.3, max: 2.5, step: 0.01, unit: "×",
  ...
  {
    id: "audioRain", key: "audio.rain", group: "audio", label: "雨粒の密度", min: 0.3, max: 3, step: 0.01, unit: "×",
