...
export const ATMO_TUNE = {
   ...
   * エアロゾルが多い大気では過大になる。だから 1.0 未満にしている。
   * 2026-09-04 に 0.5 / 0.75 / 1.0 を実測して 0.75 にした（表は lut.glsl.ts のコメント）。
   * 0.5 は空が実写の晴天より暗く、1.0 は dawn の朝焼けを割る。
   * **lut.glsl.ts の #ifndef FLIP_MS の既定値と必ず同じにすること。**
   */
  msK: 0.75,
