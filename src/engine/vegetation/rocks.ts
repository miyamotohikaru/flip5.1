    ...
    patchMaterial(
      ...
      (shader) => {
        ...
        shader.vertexShader = replaceOnce(
          ...
          float size = (0.018 + 0.085 * pow(flip_hash11(seed * 3.0), 2.6)) * (0.7 + 0.5 * (1.0 - shore)) * alive;
        ...
        shader.fragmentShader = replaceOnce(
          ...
          `{
            ...
            vec3 grey = mix(vec3(0.20, 0.195, 0.180), vec3(0.38, 0.36, 0.325), flip_hash11(s * 3.0));
            vec3 warm = vec3(0.31, 0.245, 0.185);
